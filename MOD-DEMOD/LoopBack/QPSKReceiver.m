    ...
    methods (Access = protected)
        function setupImpl(obj, ~)
            ...
            obj.pDataDecod = QPSKDataDecoder( ...
                ...
                'BerMask',                  obj.BerMask, ...
                'pMessage',                 obj.pMessage, ...
                'pMessageLength',           obj.pMessageLength, ...
                'PrintOption',              obj.PrintOption);
        end
        
        function [RCRxSignal, timingRecSignal, fineCompSignal, DataRecovered, BER] = stepImpl(obj, bufferSignal)
            ...
            [BER, DataRecovered] = obj.pDataDecod(symFrame, isFrameValid);
        end
