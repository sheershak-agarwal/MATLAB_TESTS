...
%             obj.pTargetBits = reshape(de2bi(msgSet, 7, 'left-msb')', [], 1);
        ...
        function  [BER, Data_Recovered] = stepImpl(obj, data, isValid)
            if isValid
                ...
                obj.pRecoveredData = convertCharsToStrings(char(charSet));
                %obj.pRecoveredData = extractBetween(I_data_recovered,"##","\n");
                disp(obj.pRecoveredData);
