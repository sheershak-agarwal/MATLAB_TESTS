classdef (StrictDefaults)QPSKReceiver < matlab.System
    ...
    methods (Access = protected)
        function setupImpl(obj, ~)
            ...
            obj.pDFE = comm.DecisionFeedbackEqualizer( ...
                'Algorithm',            'CMA', ...
        ...
        function [RCRxSignal, timingRecSignal, fineCompSignal, BER] = stepImpl(obj, bufferSignal)
            ...
            equalizedSignal = obj.pDFE(fineCompSignal, true);
            
            [prbIdx, dtMt] = obj.pPrbDet(equalizedSignal);                % Detect frame header

            [symFrame, isFrameValid] = obj.pFrameSync(equalizedSignal, ...
